...
const char *input_bin = "../tests/yolo3_tetrapack/layers/input.bin";
const char *c0_bin    = "../tests/yolo3_tetrapack/layers/c0.bin";
const char *c1_bin    = "../tests/yolo3_tetrapack/layers/c1.bin";
const char *c2_bin    = "../tests/yolo3_tetrapack/layers/c2.bin";
const char *c3_bin    = "../tests/yolo3_tetrapack/layers/c3.bin";
const char *c5_bin    = "../tests/yolo3_tetrapack/layers/c5.bin";
const char *c6_bin    = "../tests/yolo3_tetrapack/layers/c6.bin";
const char *c7_bin    = "../tests/yolo3_tetrapack/layers/c7.bin";
const char *c9_bin    = "../tests/yolo3_tetrapack/layers/c9.bin";
const char *c10_bin   = "../tests/yolo3_tetrapack/layers/c10.bin";
const char *c12_bin   = "../tests/yolo3_tetrapack/layers/c12.bin";
const char *c13_bin   = "../tests/yolo3_tetrapack/layers/c13.bin";
const char *c14_bin   = "../tests/yolo3_tetrapack/layers/c14.bin";
const char *c16_bin   = "../tests/yolo3_tetrapack/layers/c16.bin";
const char *c17_bin   = "../tests/yolo3_tetrapack/layers/c17.bin";
const char *c19_bin   = "../tests/yolo3_tetrapack/layers/c19.bin";
const char *c20_bin   = "../tests/yolo3_tetrapack/layers/c20.bin";
const char *c22_bin   = "../tests/yolo3_tetrapack/layers/c22.bin";
const char *c23_bin   = "../tests/yolo3_tetrapack/layers/c23.bin";
const char *c25_bin   = "../tests/yolo3_tetrapack/layers/c25.bin";
const char *c26_bin   = "../tests/yolo3_tetrapack/layers/c26.bin";
const char *c28_bin   = "../tests/yolo3_tetrapack/layers/c28.bin";
const char *c29_bin   = "../tests/yolo3_tetrapack/layers/c29.bin";
const char *c31_bin   = "../tests/yolo3_tetrapack/layers/c31.bin";
const char *c32_bin   = "../tests/yolo3_tetrapack/layers/c32.bin";
const char *c34_bin   = "../tests/yolo3_tetrapack/layers/c34.bin";
const char *c35_bin   = "../tests/yolo3_tetrapack/layers/c35.bin";
const char *c37_bin   = "../tests/yolo3_tetrapack/layers/c37.bin";
const char *c38_bin   = "../tests/yolo3_tetrapack/layers/c38.bin";
const char *c39_bin   = "../tests/yolo3_tetrapack/layers/c39.bin";
const char *c41_bin   = "../tests/yolo3_tetrapack/layers/c41.bin";
const char *c42_bin   = "../tests/yolo3_tetrapack/layers/c42.bin";
const char *c44_bin   = "../tests/yolo3_tetrapack/layers/c44.bin";
const char *c45_bin   = "../tests/yolo3_tetrapack/layers/c45.bin";
const char *c47_bin   = "../tests/yolo3_tetrapack/layers/c47.bin";
const char *c48_bin   = "../tests/yolo3_tetrapack/layers/c48.bin";
const char *c50_bin   = "../tests/yolo3_tetrapack/layers/c50.bin";
const char *c51_bin   = "../tests/yolo3_tetrapack/layers/c51.bin";
const char *c53_bin   = "../tests/yolo3_tetrapack/layers/c53.bin";
const char *c54_bin   = "../tests/yolo3_tetrapack/layers/c54.bin";
const char *c56_bin   = "../tests/yolo3_tetrapack/layers/c56.bin";
const char *c57_bin   = "../tests/yolo3_tetrapack/layers/c57.bin";
const char *c59_bin   = "../tests/yolo3_tetrapack/layers/c59.bin";
const char *c60_bin   = "../tests/yolo3_tetrapack/layers/c60.bin";
const char *c62_bin   = "../tests/yolo3_tetrapack/layers/c62.bin";
const char *c63_bin   = "../tests/yolo3_tetrapack/layers/c63.bin";
const char *c64_bin   = "../tests/yolo3_tetrapack/layers/c64.bin";
const char *c66_bin   = "../tests/yolo3_tetrapack/layers/c66.bin";
const char *c67_bin   = "../tests/yolo3_tetrapack/layers/c67.bin";
const char *c69_bin   = "../tests/yolo3_tetrapack/layers/c69.bin";
const char *c70_bin   = "../tests/yolo3_tetrapack/layers/c70.bin";
const char *c72_bin   = "../tests/yolo3_tetrapack/layers/c72.bin";
const char *c73_bin   = "../tests/yolo3_tetrapack/layers/c73.bin";
const char *c75_bin   = "../tests/yolo3_tetrapack/layers/c75.bin";
const char *c76_bin   = "../tests/yolo3_tetrapack/layers/c76.bin";
const char *c77_bin   = "../tests/yolo3_tetrapack/layers/c77.bin";
const char *c78_bin   = "../tests/yolo3_tetrapack/layers/c78.bin";
const char *c79_bin   = "../tests/yolo3_tetrapack/layers/c79.bin";
const char *c80_bin   = "../tests/yolo3_tetrapack/layers/c80.bin";
const char *c81_bin   = "../tests/yolo3_tetrapack/layers/c81.bin";
const char *g82_bin  = "../tests/yolo3_tetrapack/layers/g82.bin";
const char *c84_bin   = "../tests/yolo3_tetrapack/layers/c84.bin";
const char *c87_bin   = "../tests/yolo3_tetrapack/layers/c87.bin";
const char *c88_bin   = "../tests/yolo3_tetrapack/layers/c88.bin";
const char *c89_bin   = "../tests/yolo3_tetrapack/layers/c89.bin";
const char *c90_bin   = "../tests/yolo3_tetrapack/layers/c90.bin";
const char *c91_bin   = "../tests/yolo3_tetrapack/layers/c91.bin";
const char *c92_bin   = "../tests/yolo3_tetrapack/layers/c92.bin";
const char *c93_bin   = "../tests/yolo3_tetrapack/layers/c93.bin";
const char *g94_bin  = "../tests/yolo3_tetrapack/layers/g94.bin";
const char *c96_bin   = "../tests/yolo3_tetrapack/layers/c96.bin";
const char *c99_bin   = "../tests/yolo3_tetrapack/layers/c99.bin";
const char *c100_bin  = "../tests/yolo3_tetrapack/layers/c100.bin";
const char *c101_bin  = "../tests/yolo3_tetrapack/layers/c101.bin";
const char *c102_bin  = "../tests/yolo3_tetrapack/layers/c102.bin";
const char *c103_bin  = "../tests/yolo3_tetrapack/layers/c103.bin";
const char *c104_bin  = "../tests/yolo3_tetrapack/layers/c104.bin";
const char *c105_bin  = "../tests/yolo3_tetrapack/layers/c105.bin";
const char *g106_bin  = "../tests/yolo3_tetrapack/layers/g106.bin";
const char *output_bins[3] = {
    "../tests/yolo3_tetrapack/debug/layer82_out.bin",
    "../tests/yolo3_tetrapack/debug/layer94_out.bin",
    "../tests/yolo3_tetrapack/debug/layer106_out.bin"
};
...
int main() {
    ...
    tk::dnn::NetworkRT netRT(&net, "yolo3_tetrapack.rt");
